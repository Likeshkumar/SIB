...
<script>
	...
	function validateCard(type){
		...
		if( orderrefno ){
			if( orderrefno.value == "" ){ 
				errMessage(orderrefno, "Order Ref Number is empty..."); 
				return false; 
				}
		}
		/* if( msterorprobbin ){
			if( msterorprobbin.value != "551270" ){ 
				errMessage(cardno, "Entered order Ref Number is not Master Card Bin "); 
				return false; 
				}
		} */
	...
	{
		//alert("dsds");
		document.reportsgen.action = "ReissuCustRegInstCardRegisterProcess.do";
...
<form action="SaveReissuCustomerRegInstCardRegisterProcess.do" method="post" autocomplete="off"  name="reportsgen"    namespace="/">
   ...
   <s:hidden name="address2" value="%{cardregbean.paddress2}" /> 
		...
		<tr id="cardrow">
			 <td align="left" colspan="2">&nbsp;
			 	<div style="width:400px;" id='divcard'>
			 		Hot Listed Card Number &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :  <input type='text' name='cardno' id='cardno' value="${cardno}" maxlength='19' />
			 	</div>
			 	 <s:if test="%{!cardno.isEmpty()}">
			 	 <td>
			 	<div style="width:400px;" id='divcard'>
			 		Order Ref Number &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :  <input type='text' name='orderrefno' id='orderrefno'  maxlength='19' />
			 	</div>
			 	</td>
			 	</s:if>
			</td>  
	...
	<table border="0" cellpadding="0" cellspacing="0" width="15%" >
		...
		<td>
		  ...
		  <s:if test="%{!cardno.isEmpty()}">
		<td>
			<s:submit type="Submit" name="Submit" id="Submit" value="Register" onClick=" return validateCard(this.form)"/>
		</td>
		</s:if>
		</tr>
</table>
...
<!-- <table width="100%" cellpadding="0"  border="0"  cellspacing="0"  class="formtable"  > -->
		...
		<table border="0" cellpadding="" cellspacing="0" width="80%" align="center" class="filtertab">
