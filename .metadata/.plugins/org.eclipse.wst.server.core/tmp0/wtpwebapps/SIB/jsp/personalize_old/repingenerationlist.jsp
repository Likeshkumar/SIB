...
<div align="center">
<s:form action="rePingenerationProcessRePincreationAction"  name="authrizeorder"  autocomplete = "off"  namespace="/">
	...
	<table width="90%" cellpadding="0"  border="0"  cellspacing="0"  class="formtable"  >
			<tr>
				...
				<s:iterator value="perspingenorders">
					...
					<input type="hidden" name="code_branch" id="code_branch" value="${BRANCH_CODE}">  
			 	</s:iterator>
