...
<form action="saveCBSGlCodeGLConfigure.do" method="post" autocomplete="off">
	
	<table style="border:1px solid #efefef" cellpadding="0" border="0"  style="text-align:center" width="50%" cellspacing="0"  >
		 ...
		 <tr> 	 
		  ...
		  <tr> 	 
			  <td>Enitity ID   </td>
			 <td> :
			 	<input type="text" name="enitityid" id="entityid" />
			 	</br><small class="dt"> &nbsp;&nbsp; Entity id can be Atm id, Merchant id, Bin Number ...etc</small>
