...
<s:form action="cardIssueorderauthlistPersonalCardReceiveIssueAction"  name="perscardgen" autocomplete = "off" namespace="/" class="formtable"> 
	...
	<tr>
		...
		<td> :
 				<select name="cardtype" id="cardtype">
	 				...
	 				<s:iterator  value="personalproductlist11">
