...
<s:form action="nameFileDownloadCustomerNamePrintAction"  name="orderform"  autocomplete = "off"  namespace="/">
...
<table id="example" border="0" cellpadding="0" width="95%" cellspacing="0" class="pretty">
	 	...
	 	<br>
	 	<div align="center">
	 		<s:submit name="authorize" id="authorize" value=" Generate File " onclick="return branchwiseaction(this.form)" />
