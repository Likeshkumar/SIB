...
function getPrefilename()
{
	...
	var url = "getPREFilenameByBranchAndProductPersonalCardReceiveIssueAction.do?branchcode="+branchcode.value+"cardtype="+cardtype.value; 
...
<s:form action="getPreauthorizeordersPreprocessAction"  name="perscardgen" autocomplete = "off" namespace="/">
