...
<s:form action="txnFileDownActionSettlementProcess.do"  name="orderform" onsubmit="return validateFilter()" autocomplete = "off"  namespace="/">
...
<table border="0" cellpadding="0" cellspacing="0" width="50%" class="filtertab">	 
    ...
    <tr>	
		...
		<td> : <s:select label="PRODUCT"
				headerKey="-1" headerValue="--- Select---"
				list="settlementfilebean" 
				listValue="%{SETTLE_FILE_NAME}"
    			listKey="%{SETTLE_FILE_NAME}"  
   				name="settlefilename" id="settlefilename" > 
   				</s:select> 
		</td>
	</tr>  
</table> 
