...
public class KeysEncryptAndDecrypt {
	...
	public   String encrypty(String cdmk,byte[] ivFactor,String cdpk) throws KeyException, Exception{
	 ...
	 * @throws Exception
	 */
	public  String decrypt(String cdmk,byte[] ivFactor,String edpk) throws KeyException, Exception{
		IvParameterSpec iv = new IvParameterSpec(ivFactor);
		SecretKeySpec skeySpec = new SecretKeySpec(cdmk.getBytes(), "AES");
		Cipher cipher = Cipher.getInstance("AES/CBC/PKCS5Padding");
