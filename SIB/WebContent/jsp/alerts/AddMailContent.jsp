...
<form action="savemailcontentAddMailAction.do" method="post" autocomplete="off">
<input type="hidden" name="instid" id="instid" value="<%=instid%>" />

<table>
	<tr><td>CONFIGURATIONS :</td><td class="textcolor"><s:property value="mbean.alertdesc" /></td></tr>
	<tr>
		<td>TO :</td>
		<td>
			<s:textarea id="tomails"  name="tomails"  style="width: 599px; height: 25px;"  readonly="readonly"></s:textarea>
	...
	<tr>
		<td>CC :</td>
		<td>
			<s:textarea id="cc_mail" name="cc_mail" style="width: 599px; height: 25px;"  readonly="readonly"></s:textarea>
			<img src="images/addnew.png"  alt="Add " title='Add' class='viewinfo'/>
		</td>
	</tr>
	<tr>
		<td>SUBJECT :</td>
		<td>
			<s:textarea id="subject" name="subject" rows="1" style="width: 599px;height: 50px" ></s:textarea>
		</td>
	</tr>
	<tr>
		<td></td>
	...
	<tr>
		<td></td>
		<td><s:textarea name="content" id="content"></s:textarea></td>
	...
	<tr>
		<td></td>
		<td align="center"><s:submit value="Submit" onclick="return validationmail()"/><s:submit value="Cancel"/></td>
	</tr>
</table>
