	 ...
	 <tr> 
    	...
    	<td>    		
    			: <select name="cardstatus" id="cardstatus">
    				...
    				<option value="01">Waiting Pin Generation</option>
    				<option value="02">Waiting PRE Generation</option>
    				<option value="03">Waiting Card for Receive</option>
    				<option value="04">Waiting Card for Activation</option>
    			</select>    		
    	</td>
    </tr> 
		<td class="fnt">
		...
		<td>
 				: <select name="cardtype" id="cardtype" onchange="return Gettingsubproductlist();" >
...
<table border="0" cellpadding="0" cellspacing="4" width="20%" >
	<tr>
		<td>
			<s:hidden name="cardstatus" id="cardstatus" value="01"/>
