...
public class ServiceBeans {
	...
	public String getLukumeternumber() {
		return lukumeternumber;
	}
	public void setLukumeternumber(String lukumeternumber) {
		this.lukumeternumber = lukumeternumber;
	}
