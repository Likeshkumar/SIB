...
document.getElementById("title").innerHTML="Card Maintenance  "+"<% out.print(maintdesc);%>";
	...
	function showMaintain( instid, hcardno,mcardno,cardnumber ){
		//alert(cardno); 
		var url = "showMaintainCardMaintainAction.do?instid="+instid+"&hcardno="+hcardno+"&mcardno="+mcardno+"&cardnumber="+cardnumber;
...
<s:form action="searchListCardMaintainAction.do" name="orderform"
