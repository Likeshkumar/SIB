...
/*  $('#actionhead').change(function() {
 ...
 function loadSubAction( actionhead ){
	//alert( actionhead ); 
  	...
  	var url = "getsubActionListReportAction.do?actionhead="+actionhead;
...
<div align="center">
	<s:form action="generateAuditReportReportAction.do" autocomplete="off"  name="reportsgen" onsubmit="return validateForm()" namespace="/">
	...
	<tr>
			...
			<select  id="cardprocess" name="cardprocess"   >
						...
						<option value='PERS'> PERSONALIZED </option>    					
			</select>    
		...
		<tr id="actionrow" style="display:none">
			...
			<td>
				...
				<tr>
					<td>
						<select  id="actionhead" name="actionhead" style='height:140px' multiple="multiple"  >
