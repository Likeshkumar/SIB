...
function loadbatchId(){
	...
	//alert("act --- "+act);var authstatus;
	if(act=='C'){
		authstatus ="and AUTH_STATUS='0' and STATUS_CODE='05'";
	}else{
		authstatus ="and AUTH_STATUS='1' and STATUS_CODE='04'";
	}
...
<form action="getBatchIssuanceBatchIssuanceProcess.do" autocomplete="off" name="denomconfig" >
