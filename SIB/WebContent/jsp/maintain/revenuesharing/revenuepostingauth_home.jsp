...
<s:form action="revPostingAuthListRevenueSharing.do"  name="orderform"  enctype="multipart/form-data"  onsubmit="return validateForm()"  autocomplete = "off"  namespace="/">
...
<table border="0" cellpadding="0" cellspacing="0" width="40%" class="formtable">	 
	 ...
	 <td> : <s:select name="commissionfor" id="commissionfor"  list="#{'$ALL':'ALL','$FLOAT':'Float','$MB-NIR':'Bpesa-Revenue','$MC':'Merchant'}"  onchange="showCommissionType(this.value)" headerKey="-1" headerValue="-SELECT-" /> </td></tr>
...
<table border="0" cellpadding="0" cellspacing="4" width="20%" >
		<tr>
		<td>
			<s:submit value="Submit" name="order" id="order" onclick="return confirmProcess()"/>
		</td>
		<td>
