...
<div align="center">
<s:form action="savepersonalorderPersonalCardOrderAction"  name="custinfoform" autocomplete = "off" namespace="/">
  ...
  <tr>
	...
	<td align ="left">
		<input type="text" name="fname" id="fname" maxlength="15" onKeyPress=" return alphabets(event);" style="width:150px">
	</td>
	<td align="left">Middle Name<b class="mand">*</b></td>
	<td>
		<input type="text" name="mname" id="mname" maxlength="15" onKeyPress=" return alphabets(event);" style="width:150px">
	</td>
	<td align="left">Last Name<b class="mand">*</b></td>
	<td> 
		<input type="text" name="lname" id="lname" maxlength="15" onKeyPress=" return alphabets(event);" style="width:150px">
	</td>
  </tr>
  <tr>
	<td align="left">Father Name<b class="mand">*</b></td>
	<td>
		<input type="text" name="f_name" id="f_name" maxlength="15" onKeyPress=" return alphabets(event);" style="width:150px">
	</td>
	<td align="left">Mother Name<b class="mand">*</b></td>
	<td>
		<input type="text" name="m_name" id="m_name" maxlength="15" onKeyPress=" return alphabets(event);" style="width:150px">
	</td>
	<td align="left">Gender<b class="mand">*</b></td>
	<td>
		<s:radio list="#{'M':'Male','F':'Female'}" id="gender" name="gender" value="'M'"/>
	</td>
 </tr>
  <tr>
		<td align="left">MaritalStatus<b class="mand">*</b></td>
		<td>
			<s:radio list="#{'M':'Married','U':'Single'}" name="mstatus" id="mstatus" value="'M'" onchange="enableSpoucenamefiled(this.value);"/>
		</td>
		<td align="left">Spouse Name<b class="mand">*</b></td>
		<td>
			<input type="text" name="spname" id="spname" maxlength="25" onKeyPress=" return alphabets(event);" style="width:150px">
		</td>
		<td align="left">Occupation<b class="mand">*</b></td>
		<td>
		<input type="text" name="work" id="work" maxlength="25" onKeyPress=" return alphabets(event);" style="width:150px">
		</td>
  </tr>
  </table>
 </fieldset>
 ...
 <table border='0' width="100%" cellspacing="5" cellpadding="5">
  <tr>
	...
	<td>
		<input type="text" name="dob" id="dob"  readonly="readonly" onchange="return yearvalidation(this.id);" style="width:160px">
  ...
  <tr>
	...
	<td>
		<input type="text" name="appdate" id="appdate"  readonly="readonly" onchange="return yearvalidation(this.id);" style="width:160px">
	...
	<td><s:textfield name="mobile" id="mobile"  maxlength="13" /></td>
	<td align="left">Phone Number<b class="mand">*</b></td>
	<td><s:textfield name="phone" id="phone" maxlength="15" /></td>
  ...
  <tr>
	...
	<td>
   	...
   	<td><input type="text" name="idno" id="idno" maxlength="30" onKeyPress=" return alphanumerals(event);"></td>
	<td align="left">Application Number<b class="mand">*</b></td>
	<td><s:textfield name="appno" id="appno" maxlength="30" onKeyPress=" return numerals(event);"/></td>   	
  </tr>
  </table>
 </fieldset>
 <br>
