...
<s:form name="accounttypeform" action="saveAccountTypeAccountTypeAction.do" autocomplete="off" onsubmit="return validateAccountType()" >
...
<div align="center">
 <table border="0" cellpadding="0" cellspacing="0" width="50%" class="table" align="center">
		...
		<tr>
			...
			<td><s:textfield name="accounttypeid" id="accounttypeid" maxlength="%{accounttypelenval}" onkeyup="validateNumber('ACCOUNT TYPE ID',this.id,this.value)" ></s:textfield></td> 
		...
		<tr>
			...
			<td><s:textfield name="accounttypename" id="accounttypename"  maxlength="25" onkeyup="chkChars('ACCOUNT TYPE NAME',this.id,this.value)" ></s:textfield></td> 
