 ...
 <script>
 	...
 	function getcardslist()
 	{
		...
		if( otptype ){ if( otptype.value == "-1") { errMessage(otptype, "Select OTP Type !");return false; } }
 		...
 		document.orderform.action = "otpcardslistrepinInstCardRegisterProcess.do";
...
<s:form action="confrimotpchangestatusforREPINInstCardRegisterProcess"  name="orderform" onsubmit="return validateFilter()" autocomplete = "off"  namespace="/">
...
<table border="0" cellpadding="0" cellspacing="0" width="80%">
     ...
     <s:select list="#{'RO':'RePinCardsForOTP'}" id="otptype"  headerKey="-1" headerValue="-SELECT-" name="otptype" /> </td>
