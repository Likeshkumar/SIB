...
<s:form action="decryptDBencryptionAction.do"  method="post" name="orderform" autocomplete = "off"  namespace="/">
	<table border="0" cellpadding="0" cellspacing="4" width="50%" class="formtable">
	

				<tr>
					<td>Enter Encrypted Value </td>
					<td>
						<s:textfield name="decrypt" id="decrypt"/>
					</td>
				</tr>
