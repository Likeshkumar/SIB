...
/*  $('#actionhead').change(function() {
 ...
 function validateForm(){
	 ...
	 // alert(actionhead.value);
	  ...
	  if( subaction ){
		  if( subaction.value == "" ){  errMessage(subaction, "Select any Action");  return false;  }
	  }
...
<div align="center">
	<s:form action="generateCardReportActiveCardReport.do" autocomplete="off"  name="reportsgen" namespace="/"> 
	<%-- <s:form action="generateCardReport1ActiveCardReport.do" autocomplete="off"  name="reportsgen" namespace="/">    --%>
	   ...
	   <td>
		...
		<tr id="actionrow" >
			...
			<td>
				<table border='0' cellpadding='0' cellspacing='0' width='70%' style="margin:0 0"   >
				<tr>
					<td>
						<select  id="subaction" name="subaction" style='height:40px' multiple="multiple"  >
						<option value='$PERSONALIZED'>PERSONALIZED CARDS</option>
						<option value='$INSTANT'>INSTANT CARDS</option>
