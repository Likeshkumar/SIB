...
<s:form action="viewPREListInstCardPREProcess"  name="orderform" onsubmit="return validateFilter()" autocomplete = "off"  namespace="/">
...
<table border="0" cellpadding="0" cellspacing="0" width="70%" class="">	 
	...
	<%	
		...
		<td> 
 				...
 				<!-- <option value="ALL">ALL</option> -->
 				<option value="-1~-1">--Select Product--</option>
