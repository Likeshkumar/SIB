...
<s:form action="debitCustomerRegViewDebitCustomerRegister.do"  name="orderform" onsubmit="return showProcessing()" autocomplete = "off"  namespace="/">
 
<table border="0" cellpadding="10" cellspacing="0" width="60%" class="formtable">	 
<tr>
	<td> Customer type </td>
	<td>  : <input type="radio" name="customertype" id="newcust" value="$NEW" onclick="showDebitUser(this.value)" checked /> New Customer  </td>
