...
public class Settings extends BaseAction{
	...
	public String goConfig()	 
	{
		...
		System.out.println( "branch code is ___________ ");
		 trace( "branch code is ___________ util ");
	...
	public String insertSet()
	{
		...
		IfpTransObj transobj = comInsntance().myTranObject("INSERT",txManager);
		HttpSession session=getRequest().getSession(); 
		...
		try
			...
			int x=comInsntance().executeTransaction(inst_settings, jdbctemplate);
