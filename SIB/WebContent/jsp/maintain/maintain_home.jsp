...
//alert(statuscode);
	...
	if(statuscode.value=='07'){
		if(confirm("Are you Sure Want to Re - Issue this card , Once Re - Issued the Temp Block card will be marked as Lost/Stolen?")){
			//alert("1");
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="formtable1" style="text-align:left">
		...
		<%-- <tr>
			...
			<td>: 
				...
				%>
				 <s:property value="custid" />  <a href="" style="color:red" onclick="showCustomerDetails('<s:property value="enccardno" />'	)"> View customer detail </a>  		
				<% } %>
			</td>
		</tr> --%>
...
<sx:div id="two" label="Pin Management Details">
	<div align="center">
		<table border="0" cellpadding="0" cellspacing="0" width="50%" class="formtable1" >
			<tr align="center">
				<td colspan="2"  style="font-weight:bold;color:maroon"> <div> Pin Management Details </div> </td>
			</tr>
			
			<tr>
				<td width="40%" >Card No</td>
				<td>: <s:property value="mcardno" /></td>
			</tr>
			
			<tr>
				<td width="40%"  >Account No</td>
				<td>: <s:property  value="acccountno" /></td>
			</tr>
			...
			<tr>
				<td>Number Of Times Pin Changed</td>
				<td>: <s:property value="nopinchange" /></td>
			</tr>
			
			<tr>
				<td>Number of Times Wrong Pin Entered</td>
				<td>: <s:property value="wrongpin" /></td>
			</tr>
			
			<tr>
				<td>Pin Block Date</td>
				<td>: <s:property value="pinblock" /></td>
			</tr>
			
			
			 <tr>
				<td>Card Activated Date</td>
				<td>:
					<s:iterator value="cardactivelist">
						<s:property value="ACTIVEDATE"/>
					</s:iterator>						
				</td>
			...
			<tr>
				<td>Pin Changed Date</td>
				<td>: 	
					<select  id="pinchange" name="pinchange" style='height:80px' multiple="multiple">
					<s:iterator value="pinchange">
 ...
 <%-- 
<sx:div id="three" label="Card Activity Details">
	<div align="center">
		<table border="0" cellpadding="0" cellspacing="0" width="50%" class="formtable1" >
			<tr align="center">
				<td colspan="2"  style="font-weight:bold;color:maroon"> <div> Card Activity Details </div> </td>
			</tr>
			...
			<tr>
				<td>Total Number Of Withdrawals</td>
				<td>: <s:property value="totalatmwithdrawal" /></td>
			</tr>
			
			<tr>
				<td>Number Of Orient ATM Withdrawl </td>
				<td>: <s:property value="atmwithdrawlcount" /></td>
			</tr>
			
			<tr>
				<td>Number Of Visa ATM Withdrawl </td>
				<td>: <s:property value="visaatmwithdrawl" /></td>
			</tr>
			
			<tr>
				<td>Number Of Inter-switch ATM Withdrawal </td>
				<td>: <s:property value="interswitchatmwithdr" /></td>
			</tr>
			
			
			<tr>
				<td>Number Of POS Transaction</td>
				<td>: <s:property value="noofpostxns" /></td>
			</tr>
			
			<tr>
				<td>Number Of Online Transactions</td>
				<td>: <s:property value="noofonlinetxns" /></td>
			</tr>
 ...
 --%>
<sx:div id="four" label="Account Status">
	<div align="center">
		<table border="0" cellpadding="0" cellspacing="0" width="50%" class="formtable1" >
			<tr align="center">
				<td colspan="2"  style="font-weight:bold;color:maroon"> <div> Account Status </div> </td>
			</tr>
			...
			<tr>
				<td> Account Type Desc</td>
				<td>:
				<s:iterator value="actypedescvalue">
						<s:property value="ACCTTYPEDESC"/>
				</s:iterator>
				</td> 				
			</tr>
			
			<tr>
				<td width="40%"  >Primary Account No</td>
				<td>: <s:property  value="acccountno" /></td>
			</tr>
			...
			<tr>
				...
				<td>: 	
					...
					<s:iterator value="getacctnolist">
