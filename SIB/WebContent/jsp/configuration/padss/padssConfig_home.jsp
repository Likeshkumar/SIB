...
<script type="text/javascript">
	...
	function validate_form() {
		...
		var url = "savesecurityKeyPadssConfigAction.do?keyname="
...
<div align="center">
	...
	<s:form action="savesecurityKeyPadssConfigAction.do" name="addkeyform" id="addkeyform" autocomplete="off">
		...
		<fieldset style="width: 850px;">
			...
			<div align="center">
				<table border="0" cellpadding="0" cellspacing="0" width="80%">
					<tr>
						<!-- <td><input type="button" name="submit" id="submit" value="Check Digit" onclick="return getdatacheckdigit ( );"></td> -->
		...
		<fieldset style="width: 850px;">
			<legend>
				<b>DPK - DATA PIN KEY COFIGURATION </b>
			</legend>
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
