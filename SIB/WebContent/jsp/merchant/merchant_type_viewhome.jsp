...
<s:form action="viewemerchantTypeMerchantRegister.do" name="orderform" onsubmit="return validateRecords()" autocomplete="off" namespace="/"> 
	<table border="0" cellpadding="0" cellspacing="0" width="60%" class="formtable"	align="center">
		<tr>
			 <td> Merchant Type : </td>
			 <td> <s:select list="mregbean.merchtypelist" name="merchanttypeid" id="merchanttypeid"
			 		listKey="MERCHANT_TYPE_ID" listValue="MERCHANT_TYPE_NAME" headerKey="-1" headerValue="-SELECT-"
			 		></s:select> </td>
		</tr> 
	</table> 
