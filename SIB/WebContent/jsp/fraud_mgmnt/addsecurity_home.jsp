...
<sx:div id="one" label="NO OF PIN ATTEMPTS" labelposition="bottom" >
	...
	<s:form action="addSecurityActionFraudManagementAction.do"  name="perscardgen" autocomplete = "off" namespace="/">
		...
		<tr>  
			...
			<td> CARD GROUP ID   </td>
			<td> : <s:select list="cardgrplist" name="cardgrpid" id="cardgrpid"  
	...
	<s:form action="addSecurityActionFraudManagementAction.do"  name="perscardgen" autocomplete = "off" namespace="/">
		...
		<tr>  
			...
			<td> : 
					  ...
					  <s:select list="cardgrplist" name="cardgrpid" id="cardgrpid"  
						headerKey="-1" headerValue="-SELECT-"
						listValue="%{CARD_NAME}"
						listKey="%{CARDGRP_ID}" 
					 />  
...
<sx:div id="four" label="NO OF PIN TXN" labelposition="top" >
	...
	<s:form action="addSecurityActionFraudManagementAction.do"  name="perscardgen" autocomplete = "off" namespace="/">
		...
		<tr>  
			<td> SMS REQUIRED </td>
			<td> : <s:checkbox name="smsrequired" id="smsrequired" onclick="enableSMS(this.checked, smsgrpid21)"/> </td>
			
			<td id="tdsmsgrp1"> SMS GROUP </td>
			<td  > : <s:select list="smsgrouplist" name="smsgrpid" id="smsgrpid21"  disabled="true"
						headerKey="-1" headerValue="-SELECT-"
						listValue="%{SMSGRP_NAME}"
						listKey="%{SMSGRP_ID}" 
			 /> </td>
