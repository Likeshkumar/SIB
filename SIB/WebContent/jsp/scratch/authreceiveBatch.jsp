...
function loadbatchId(){
	...
	var authstatus;
	var act = document.getElementById("act").value;	if(act=='C'){authstatus ="and AUTH_STATUS='0' and STATUS_CODE='04'";}
	else{authstatus ="and AUTH_STATUS='1' and STATUS_CODE='03'";}		
	if( productcode != -1 ){
