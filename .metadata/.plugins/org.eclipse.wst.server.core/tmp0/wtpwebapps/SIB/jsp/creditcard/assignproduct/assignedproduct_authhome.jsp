...
%>
<form action="assignProductAuthViewCreditProductLimit.do" onsubmit="return validateForm()" autocomplete="off" method="post">
<table border="0" cellpadding="0" cellspacing="0" width="50%" class="formtable">	 
<s:hidden name="doact" id="doact" value="%{crlimitbean.doact}" />
<tr> 
	<td>  Application </td>
