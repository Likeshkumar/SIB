...
function showFailReport(reportrandomno){
	...
	var url = "viewFailedRecordsBulkCustomerRegister.do?filename="+reportrandomno;
	window.location = url;
}
</script>
...
<s:form action="changetoloststoneBulkCustomerRegister.do" method="POST" onsubmit="parent.showprocessing()" enctype="multipart/form-data">
