...
<s:form action="authorizeDeauthorizeAddLimitAction" id="limitform" name="limitform" autocomplete="off">
...
<div align="center">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" align= "center" class="table">
		...
		<th>
		<th>CARD NO : <s:property value="%{cardno}" /></th></th>
				...
				<table border='1' cellpadding='0' cellspacing='0' width='100%' class="formtable">
					...
					<s:iterator value="limitvalueDetails">
						...
						<tr> 
								...
								<td align=right> 
									<input type='text' style='width:100px;text-align:right' value="${AMOUNT}"/> 
								</td>	
								<td align=right> 
									<input type='text' style='width:100px;text-align:right' value="${COUNT}"/>  
								</td>
								<td align=right> 
									<input type='text' style='width:100px;text-align:right' value="${WAMOUNT}"/>  
								</td>
								<td align=right> 
									<input type='text' style='width:100px;text-align:right' value="${WAMOUNT}"/>  
								</td>
								<td align=right> 
									<input type='text' style='width:100px;text-align:right' value="${MAMOUNT}"/>  
								</td>
								<td align=right> 
									<input type='text' style='width:100px;text-align:right' value="${MAMOUNT}"/>  
								</td>
								<td align=right> 
									<input type='text' style='width:100px;text-align:right' value="${YAMOUNT}"/>  
								</td>
								<td align=right> 
									<input type='text' style='width:100px;text-align:right' value="${YAMOUNT}"/>  
								</td>
