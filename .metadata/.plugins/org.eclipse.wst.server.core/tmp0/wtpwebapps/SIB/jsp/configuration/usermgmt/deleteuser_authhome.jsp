...
<s:form action="deleteauthViewDataUserManagementAction.do"  name="orderform" onsubmit="return showProcessing()" autocomplete = "off"  namespace="/">
...
<table border="0" cellpadding="0" cellspacing="0" width="30%" class="formtable">	 
    ...
    <tr>
		...
		<td> : <s:property value="instname"/> 
 				<s:hidden name="instid" id="instid" value="%{institutionid}" />
		</td>
    </tr>
