...
<s:form action="orderViewInstCardorderAction"  name="orderform" onsubmit="return validateFilter()" autocomplete = "off"  namespace="/">
 
<table border="0" cellpadding="0" cellspacing="0" width="65%" align="center" class="">	 
...
<table border="0" cellpadding="0" cellspacing="4" width="20%" >
		<tr>
		<td>
			<s:submit value="Order" name="order" id="order" />
		</td>
		<td>
