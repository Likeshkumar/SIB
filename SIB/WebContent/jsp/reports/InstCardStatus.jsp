...
function validateValues()
{
	...
	var cardstat 	= document.getElementById("cardstatus");
...
<s:form action="genInstCardReportStatusReportgenerationAction"  name="personalorderform" autocomplete = "off" namespace="/" javascriptTooltip="true">
<table border="0" cellpadding="0" cellspacing="5" width="50%" id="maxcount" class="formtable">
	...
	<tr>
	 <tr> 
		...
		<td>
 				: <select name="cardtype" id="cardtype" onchange="return Gettingsubproductlist('N');" >
