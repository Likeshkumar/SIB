...
<s:form action="decryptCardDecryption.do"  method="post" name="orderform" autocomplete = "off"  namespace="/">
	<table border="0" cellpadding="0" cellspacing="4" width="50%" class="formtable">
	

				<tr>
					<td>Enter Encrypted CHN </td>
					<td>
						<s:textfield name="decrypt" id="decrypt"  maxlength="44"/>
					</td>
				</tr>
