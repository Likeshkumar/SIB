...
function loadbatchId(){
	...
	var tablename="IFS_BATCHPROCSS_TEMP";
	var act = document.getElementById("act").value;
	if(act=='C'){var authstatus ="and AUTH_STATUS='0' and MKCKSTATUS='M' and STATUS_CODE='01'";}
	else{var authstatus ="and STATUS_CODE='01'";}		
	if( productcode != -1 ){
		var url = "getBatchIdBatchGenerationProcess.do?productcode="+productcode+"&authstatus="+authstatus+"&tablename="+tablename+"&denomvalue="+denomvalue+"&batchid="+batchid;
		var result = AjaxReturnValue(url);
		//alert(result);
...
<form action="viewBatchDetailsBatchGenerationProcess.do" autocomplete="off" name="denomconfig" >
