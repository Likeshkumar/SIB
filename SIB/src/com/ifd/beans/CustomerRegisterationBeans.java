...
public class CustomerRegisterationBeans {
	private List listofyears;
	private List documentlist;
	private List supplimentrelationlist;
	...
	private String tab2_currency;
	
	
	private List accuntsubtypelist;
	...
	private String p_poxbox;
	private String p_houseno;
	private String p_streetname;
	private String p_wardnumber;
	private String p_city;
	private String p_district;
	private String p_phone1;
	private String p_phone2;
 
	private String c_poxbox;
	private String c_houseno;
	private String c_streetname;
	private String c_wardnumber;
	...
	private String tab3Status; 
	private String tab4Status;
	...
	public String getTab1Status() {
		return tab1Status;
	}
	public void setTab1Status(String tab1Status) {
		this.tab1Status = tab1Status;
	}
	public String getTab2Status() {
		return tab2Status;
	}
	public void setTab2Status(String tab2Status) {
		this.tab2Status = tab2Status;
	}
	public String getTab3Status() {
		return tab3Status;
	}
	public void setTab3Status(String tab3Status) {
		this.tab3Status = tab3Status;
	}
	public String getTab4Status() {
		return tab4Status;
	}
	public void setTab4Status(String tab4Status) {
		this.tab4Status = tab4Status;
	}
	...
	public List getAccuntsubtypelist() {
		return accuntsubtypelist;
	}
	public void setAccuntsubtypelist(List accuntsubtypelist) {
		this.accuntsubtypelist = accuntsubtypelist;
	}
	...
	public String getAcctnolen() {
		return acctnolen;
	}
	public void setAcctnolen(String acctnolen) {
		this.acctnolen = acctnolen;
	}
	...
	public void setGotoval(String gotoval) {
		this.gotoval = gotoval;
	}
	...
	public String getMiddlename() {
		System.out.println("testing:::"+middlename==null?"":middlename);
	...
	public String getDocumentprovided() {
		return documentprovided==null?"":documentprovided;
	}
	public void setDocumentprovided(String documentprovided) {
	...
	public String getTab2_currency() {
		return tab2_currency;
	}
	public void setTab2_currency(String tab2_currency) {
		this.tab2_currency = tab2_currency;
	}
	...
	public String toString() {
		return "CustomerRegisterationBeans [listofyears=" + listofyears + ", documentlist=" + documentlist
				+ ", supplimentrelationlist=" + supplimentrelationlist + ", binlist=" + binlist + ", productlist="
				+ productlist + ", cardtypelist=" + cardtypelist + ", subproductlist=" + subproductlist
				+ ", accttypelist=" + accttypelist + ", branchlist=" + branchlist + ", acctnolen=" + acctnolen
				+ ", reglevel=" + reglevel + ", gotoval=" + gotoval + ", doact=" + doact + ", applicationlist="
				+ applicationlist + ", applicationid=" + applicationid + ", customeridno=" + customeridno
				+ ", cinidbasedon=" + cinidbasedon + ", cinnoLength=" + cinnoLength + ", branchcode=" + branchcode
				+ ", embname=" + embname + ", encname=" + encname + ", bin=" + bin + ", productcode=" + productcode
				+ ", subproduct=" + subproduct + ", cardtypeid=" + cardtypeid + ", limitbasedon=" + limitbasedon
				+ ", limitid=" + limitid + ", limitname=" + limitname + ", feecode=" + feecode + ", feename=" + feename
				+ ", acctno=" + Arrays.toString(acctno) + ", accttype=" + Arrays.toString(accttype) + ", usercode="
				+ usercode + ", customertype=" + customertype + ", firstname=" + firstname + ", middlename="
				+ middlename + ", lastname=" + lastname + ", dob=" + dob + ", gender=" + gender + ", mstatus=" + mstatus
				+ ", nationality=" + nationality + ", documentprovided=" + documentprovided + ", documentnumber="
				+ documentnumber + ", spousename=" + spousename + ", mothername=" + mothername + ", fathername="
				+ fathername + ", accountnovalue=" + accountnovalue + ", accounttypevalue=" + accounttypevalue
				+ ", accountsubtypevalue=" + accountsubtypevalue + ", tab2_currency=" + tab2_currency
				+ ", accuntsubtypelist=" + accuntsubtypelist + ", currencylist=" + currencylist + ", mobile=" + mobile
				+ ", email=" + email + ", p_poxbox=" + p_poxbox + ", p_houseno=" + p_houseno + ", p_streetname="
				+ p_streetname + ", p_wardnumber=" + p_wardnumber + ", p_city=" + p_city + ", p_district=" + p_district
				+ ", p_phone1=" + p_phone1 + ", p_phone2=" + p_phone2 + ", c_poxbox=" + c_poxbox + ", c_houseno="
				+ c_houseno + ", c_streetname=" + c_streetname + ", c_wardnumber=" + c_wardnumber + ", c_city=" + c_city
				+ ", c_district=" + c_district + ", c_phone1=" + c_phone1 + ", c_phone2=" + c_phone2 + ", tab1Status="
				+ tab1Status + ", tab2Status=" + tab2Status + ", tab3Status=" + tab3Status + ", tab4Status="
				+ tab4Status + ", renewal=" + renewal + ", collectbranch=" + collectbranch + ", accountnolength="
				+ accountnolength + ", applicationList=" + applicationList + "]";
	}
