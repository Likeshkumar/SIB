...
<script>
	...
	function searchRecords(){
		...
		//alert( document.getElementById("displayresult1") );
		 ...
		 var url = "searchListMerchantRegister.do?merchname="+merchnamefld.value+"&methodtype=STORE";
...
<table border="0" cellpadding="0" cellspacing="0" width="90%"  align="center" class="formtable" >	 
	<tr>
		 <td  >
			 			...
			 			<table border="0" cellpadding="0" cellspacing="0" width="50%" >
							<tr>
								<td colspan='2' style='text-align:center' >Merchant Name </td> <td> <input type='text' name='merchname' id='merchname' />
									<br/> <small style='color:#000;font-size:9px'> Enter merchant name to be  Add Store / View Store/ Edit Store or Delete Store </small>
								</td>
							</tr>
						</table>
		 		</td>
