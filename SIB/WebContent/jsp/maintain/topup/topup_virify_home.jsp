...
<s:form action="viewUploadedListForVerifyTopUpCard.do"  name="orderform"  enctype="multipart/form-data"  onsubmit="return validateForm()"  autocomplete = "off"  namespace="/">
