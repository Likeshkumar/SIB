...
<s:form action="topupAuthorizationTopUpCard"  name="orderform" onsubmit="return validateinstorder()"  autocomplete = "off"  namespace="/">
...
<table id="example" border="0" cellpadding="0" width="95%" cellspacing="0" class="pretty">
				...
				<s:iterator value="topbean.authcardlist">
					<tr> 
						<%  int rowcount = ++rowcnt; %>
						<td> <%= rowcount %> </td> 
