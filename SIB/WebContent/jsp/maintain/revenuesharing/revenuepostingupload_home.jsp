...
<s:form action="revPostingUploadActionRevenueSharing.do"  name="orderform"  enctype="multipart/form-data"  onsubmit="return validateForm()"  autocomplete = "off"  namespace="/">
...
<table border="0" cellpadding="0" cellspacing="0" width="40%" class="formtable">	 
	 ...
	 <tr>
		<td> Upload File </td>
		<td> : <s:file name="revenueupload" id="revenueupload"  />  <br/>
		
			<small id="smalldt" class="dt"> File format  bankcode_ddmmyy.xls </small>
		</td> 
	</tr>
