...
%>
<div align="center">
<s:form action="viewProcessedOrderInstCardorderAction"  name="orderform" onsubmit="return validateinstorder()" autocomplete = "off"  namespace="/">
    ...
    <tr>	
		...
		<td> : <input type="hidden" name="Ordertype" value="I">
			<input type="hidden" name="maxallowedcard" id="maxallowedcard" />
   	   		<input type="text" name="count" id="count"  maxlength="5" onKeyPress="return numerals(event);" onchange="checkMaxcards(this.value)">
		</td>
	</tr> -->
