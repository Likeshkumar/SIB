...
<s:form action="orderViewOnlyInstCardorderAction"  name="orderform" onsubmit="return validateFilter()" autocomplete = "off"  namespace="/">
...
<table border="0" cellpadding="0" cellspacing="0" width="80%" class="">
                  ...
                  <tr bgcolor="#3197e0" align="center">
                    ...
                    <td >From Date</td>
                    <td > To Date</td>
                    <td>Status <input type="hidden" name="Ordertype" value="I">	</td>
                    </tr>
	...
	<%	
			...
			%>
					...
					<td> : <%out.println( session.getAttribute("BRANCH_DESC") ); %></td>
						<s:hidden name="branchcode" id="branch" value="%{#session.BRANCHCODE}" />
		...
		<td> :  
			<select name="ordstatus" id="ordstatus">
				...
				<option value="P"> Authorized Order</option>
				<option value="D"> Rejected Order </option>
			</select>
		</td>
	</tr>
...
<table border="0" cellpadding="0" cellspacing="4" width="20%" >
		<tr>
		<td>
			<s:submit value="Submit" name="submit" id="submit" onclick="return validFilter();"/>
		</td>
		<td>
