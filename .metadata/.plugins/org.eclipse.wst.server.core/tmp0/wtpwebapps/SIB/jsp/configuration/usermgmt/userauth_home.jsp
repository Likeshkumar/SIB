...
<script>
	...
	function validFilter(){
		...
		if(instid.value == -1 ){
			errMessage(instid, "Select Institution Id....");
			return false;
		}
...
<s:form action="authViewDataUserManagementAction.do"  name="orderform" onsubmit="return showProcessing()" autocomplete = "off"  namespace="/">
