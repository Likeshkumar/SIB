...
<div align="center">
<s:form action="receivedPlasticcardsauthorizePersonalCardReceiveIssueAction" onsubmit="parent.showprocessing()" name="authrizeorder"  autocomplete = "off"  namespace="/">
	...
	<table width="90%" cellpadding="0"  border="0"  cellspacing="0"  class="formtable"  >
			<tr>
				...
				<s:iterator value="plasticreceivedlist" status="incr">
					<tr
