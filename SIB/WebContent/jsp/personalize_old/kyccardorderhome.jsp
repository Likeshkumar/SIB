...
<s:form action="saveKYCCardorderPersonalCardOrderAction"  name="personalorderform" autocomplete = "off" namespace="/" javascriptTooltip="true">
<table border="0" cellpadding="0" cellspacing="5" width="50%" id="maxcount">
	...
	<tr>
		...
		<td>
			<input type="text" name="custno" id="custno"  maxlength="25">
		</td>
	</tr>
