...
function getPrefilename()
{
	...
	var url = "getPREFilenameByBranchAndProductPersonalCardReceiveIssueAction.do?branchcode="+branchcode.value+"&cardtype="+cardtype.value+"&act=C"; 
...
<s:form action="authorizePlasticcardreceivedordersPersonalCardReceiveIssueAction"  name="perscardgen" autocomplete = "off" namespace="/">
