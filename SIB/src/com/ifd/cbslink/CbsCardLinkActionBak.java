...
public class CbsCardLinkActionBak extends BaseAction{
	...
	public String cardlinklist(){
		...
		String cardslistqry = "SELECT ACCT_NO,ADDED_DATE,BRANCH,CARDNO,CBS_BULK_REFID,CIN,EMB_NAME,MCARDNO,ORDER_REF_NO,TYPE,"
				+ "UPLOAD_BY,UPLOAD_RESPCODE,UPLOAD_STATUS FROM CBS_CARD_LINK WHERE INSTID=? "
				+ "AND ( to_date(?, 'dd-mm-yyyy') <= ADDED_DATE AND to_date(?, 'dd-mm-yyyy' )+1 >= ADDED_DATE)";
