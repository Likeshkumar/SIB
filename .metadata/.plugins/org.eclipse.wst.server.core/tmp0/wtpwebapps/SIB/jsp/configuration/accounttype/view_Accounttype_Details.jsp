...
function validation_deauthcardtype(){
	...
	var cardtypeid = document.getElementById("cardtypeid");
	 ...
	 if( reason ){
		 alert("EMPTY");
		 var url = "authdeauthaccountAccountTypeAction.do?reason="+reason+"&auth="+auth+"&cardtypeid="+cardtypeid.value;
		 window.location = url; 
	 }  
	 return false;
}
				...
				<td colspan='4' style='padding-top:30px'>
					<table align="center" border="0"  cellspacing="1" cellpadding="0" width="60%" class="formtable">
						<tr> 
							...
							<th style="text-align:center">ACCOUNT DESC</th>	
							<th style="text-align:center">CONFIGURED BY</th>		
							<th style="text-align:center">STATUS</th>	
							<th style="text-align:center">REASON</th>													
						</tr>
						<% int rowcnt = 0; Boolean alt=true; %> 
						<s:iterator value="cardbean.accounttype">	
