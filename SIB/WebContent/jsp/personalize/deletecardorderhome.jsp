...
<s:form action="getDeleteCardordersPersonalCardOrderAction"  name="orderdelete" autocomplete = "off" namespace="/" >
  ...
  <tr>
	...
	<tr>
	   <td align="left" class="fnt">From Date<font class="mand">*</font></td>
		...
		<img src="style/images/cal.gif" id="image" onclick="displayCalendar(document.orderdelete.fromdate,'dd-mm-yy',this);" title="Click Here to Pick up the date" border="0" width="15" height="17">
		</td>
	</tr>
	<tr>
		...
		<img src="style/images/cal.gif" id="image" onclick="displayCalendar(document.orderdelete.todate,'dd-mm-yy',this);" title="Click Here to Pick up the date" border="0" width="15" height="17">
		</td>
	</tr>
<% } %>
	<%-- <tr align="center">
