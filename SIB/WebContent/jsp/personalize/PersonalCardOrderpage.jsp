...
<table border="0" cellpadding="0" cellspacing="5" width="50%" id="maxcount" class="formtable">
   ...
   <tr> 
    	...
    	<input type="hidden" name="Count" id="Count" value="1" maxlength="5" onKeyPress="return numerals(event);">
    <!-- <tr>	
		<td>
		No. Of Cards
		</td>
	...
	<tr>
		...
		<td>
			<input type="text" name="emposs" id="emposs"  maxlength="25"   onkeyup="return coppyEmbosstoEncode(event,this.value);" >
		</td>
	</tr>
	<tr>
		<td>Encoding Name</td>
		<td>
			<input type="text" name="encode" id="encode"  maxlength="25" >
		</td>
	</tr>
