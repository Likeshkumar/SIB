...
<s:form action="revPostingVerifyActionRevenueSharing.do"  name="orderform" onsubmit="return validateinstorder()"  autocomplete = "off"  namespace="/">
...
<table id="example" border="0" cellpadding="0" width="95%" cellspacing="0" class="pretty">
	 	...
	 	<table>
	 			<tr> 	
	 					<td colspan="8">
							<s:submit value="Submit" name="approve" id="submit" onclick="parent.showprocessing()"/> 
