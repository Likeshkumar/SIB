...
<s:form action="saveDenomInfoVasAgent"  name="orderform" onsubmit="return validateForm()" autocomplete = "off"  namespace="/">
...
<table border="0" cellpadding="0" cellspacing="0" width="50%" class="formtable">	 
	...
	<td> <div id="denomdiv" style='width:100px;background:#efefef;display:none' > denom value </div> </td>
	
	</tr> 
	
	<tr><td> Denom value </td><td> : 
		 <s:textfield name="denomvalue" id="denomvalue"/>
	</td>
	<td>&nbsp; </td>	
	</tr> 
	
		<tr><td> Currency Code </td><td> : 
		 <s:textfield name="diplaycurcode" id="diplaycurcode" value="TZS" readonly="true"/>
		 <s:hidden name="curcode" id="curcode" value="834" />
	</td>
	<td>&nbsp; </td>	
	</tr> 
