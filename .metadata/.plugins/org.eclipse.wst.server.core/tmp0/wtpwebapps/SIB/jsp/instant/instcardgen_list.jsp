...
%>
<div align="center">
<s:form action="generateInstCardInstCardProcessAction"  name="orderform"  autocomplete = "off"  namespace="/">
   
	<table width="90%" cellpadding="0"  border="0"  cellspacing="0"  class="formtable"  >
				
				 	<input type="hidden" name="productcode1" value="<%= request.getParameter("cardtype") %>" />
