...
<div align="center">
<s:form action="updatepersonalorderPersonalCardOrderAction"  name="custinfoform" enctype="multipart/form-data" autocomplete = "off" namespace="/">
<div>
...
<br><br>
  ...
  <tr>
	...
	<td>
		<input type="text" name="f_name" id="f_name" maxlength="40" value="${FATHER_NAME}" onKeyPress=" return alphabets(event);" style="width:150px">
	</td>
	<td align="left">Mother Name<b class="mand">*</b></td>
	<td>
		<input type="text" name="m_name" id="m_name" maxlength="40" value="${MOTHER_NAME}" onKeyPress=" return alphabets(event);" style="width:150px">
	</td>
...
<table border='0' width="100%">
<tr>
	<td><s:textarea name="raddress1" id="raddress1" value="%{RES_ADDR1}" onKeyPress=" return alphabets(event);" style="resize: none;max-width: 191px; max-height: 100px;">
	</s:textarea></td>
	...
	<td>
		...
		<td><s:textarea name="paddress1" id="paddress1" value="%{POST_ADDR1}" onKeyPress=" return alphabets(event);" style="resize: none;max-width: 191px; max-height: 100px;">
		</s:textarea></td>
		<%-- 
