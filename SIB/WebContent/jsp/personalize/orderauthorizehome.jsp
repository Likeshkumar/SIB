...
<s:form action="getAuthrizeordersPersonalCardOrderAction" onclick="return validateFilter();"  name="orderauthhome" autocomplete = "off" namespace="/">
 ...
 <% if( datefilter_req.equals("1")) { %>
	<tr>
	   <td align="left" class="fnt">From Date<font class="mand">*</font></td>
		...
		<img src="style/images/cal.gif" id="image" onclick="displayCalendar(document.orderauthhome.fromdate,'dd-mm-yy',this);" title="Click Here to Pick up the date" border="0" width="15" height="17">
		</td>
	</tr>
	<tr>
		...
		<img src="style/images/cal.gif" id="image" onclick="displayCalendar(document.orderauthhome.todate,'dd-mm-yy',this);" title="Click Here to Pick up the date" border="0" width="15" height="17">
		</td>
	</tr>
		<% }  %>  
</table>
