...
<s:form action="uploadWalletVasWallet"  name="orderform"  enctype="multipart/form-data"  onsubmit="return validateForm()"  autocomplete = "off"  namespace="/">
...
<table border="0" cellpadding="0" cellspacing="0" width="50%" class="formtable">	 
	...
	<tr>
		...
		<td> : <s:file name="walletupload" id="walletupload"  />  <br/>
			...
			<small class="dt">  Upload the deposited amount to Merchant Wallet. File format .xls <br/>
					File name start with bank code ( Ex. SBS_xxxxxx.xls )
			 </small>
		</td> 
	</tr>
