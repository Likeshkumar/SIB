...
<s:form name="cardtypeform" action="viewAccountSubTypeDetailsAccountSubTypeAction.do" autocomplete="off">
<div align="center">
 <table border="0" cellpadding="0" cellspacing="0" width="50%" class="table" align="center">
		...
		<tr>
			...
			<td><select name="subaccounttype" id="subaccounttype"></select></td> 
