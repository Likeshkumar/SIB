...
<s:form action="getCardeditorderPersonalCardOrderAction"  name="perscardgen" autocomplete = "off" namespace="/">

<table border="0" cellpadding="0" cellspacing="0" width="50%" class="filtertab">
	<% 
	//String cardeditorder = (String)session.getAttribute("CARDOREDR_EDIT");
	...
	<tr>
		...
		<% }  %> 
	<tr align="center">
		<td colspan="2"><s:radio list="#{'0':'New Orders','1':'KYC Orders'}" id="order_flag" name="order_flag" value="'0'"/></td>
	</tr>
</table>
